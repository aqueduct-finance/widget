...
export const NinjaLoader = styled.div<{ swapTheme: any }>`
    ...
    &:before {
        ...
        background: radial-gradient(
                ...
                top left,
            radial-gradient(9px at bottom left, #0000 94%, currentColor) top
                right,
            radial-gradient(9px at top right, #0000 94%, currentColor) bottom
                left,
            radial-gradient(9px at top left, #0000 94%, currentColor) bottom
                right;
